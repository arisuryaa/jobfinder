...
?>
<!doctype html><html lang="id"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Lamar</title>
...
<div class="card p-3"><h5>Lamar Pekerjaan</h5><?php if($err): ?><div class="alert alert-danger"><?=htmlspecialchars($err)?></div><?php endif; ?>
<form method="post" enctype="multipart/form-data">
<input type="hidden" name="job_id" value="<?=$job_id?>">
<div class="mb-3"><label class="form-label">Unggah CV (PDF/DOC)</label><input type="file" name="cv" class="form-control" required></div>
