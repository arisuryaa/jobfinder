            ...
            <div class="col-md-8">
                ...
                <div class="card mb-3 shadow-sm">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <?php else: ?>
                        <div
                            style="width:80px; height:80px; background:#e9ecef; border-radius:8px; margin-right:15px; display:flex; align-items:center; justify-content:center; color:#6c757d;">
                            No Logo
                        </div>
                        <?php endif; ?>
